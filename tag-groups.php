    ...
    <div class='wrap'>
        ...
        switch ( $action ) {
            ...
            case 'theme':
                ...
                <input class='button-primary' type='button' name='ok' value='<?php _e( 'OK', 'tag-groups' ); ?>' id='ok' onclick="location.href = 'options-general.php?page=tag-groups-settings&active-tab=1'"/>
                <?php
                break;
        ...
        default:
            ...
            <?php if ( function_exists( 'icl_register_string' ) ) : ?>
                    ...
                    <a href="options-general.php?page=tag-groups-settings&active-tab=4" class="nav-tab <?php if ( $active_tab == 4 ) echo 'nav-tab-active' ?>"><?php _e( 'Delete Groups', 'tag-groups' ) ?></a>
...
function tg_add_filter()
{
    ...
    if ( !$show_filter || (count( $tg_type ) > 1) )
        return;
